...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7(
        ...
        KC_HOME,   KC_A,    KC_S,    LT(_MOUSE, KC_D),  KC_F,     KC_G,      KC_ENT,
    ...
    [_MOUSE] = LAYOUT_5x7(
        ...
        _______,   KC_WBAK,   KC_WFWD,   _______,   KC_WH_D,   _______,   _______,
        ...
        // right hand
                          ...
                          _______,   CPY_PT,    KC_WBAK,   KC_BTN3,   KC_WFWD,   KC_RSFT,   _______,
